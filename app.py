...
quiz_data = {
    "1단계": "안 촉촉한 초코칩 나라의 안 촉촉한 초코칩 1234개",
    "2단계": "동탄역에서 출발하는 SRT 열차는 2026년에 시속 300km로 달린다!",
    "3단계": "포스텍 전자과 필수 과목: 회로이론 1, 전자기학 2 (A+ 가즈아~)",
    "4단계": "Python 코딩으로 완성하는 완벽한 MT Game 100점 만점",
    "5단계": "맥스웰(Maxwell) 방정식 4가지를 10초 안에 정확히 타이핑하시오."
}
...
# ==========================================
    ...
    st.caption("⚠️ 주의: 복사/붙여넣기하면 걸립니다. (직접 치세요)")
